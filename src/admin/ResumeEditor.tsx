...
import type { EditableProfile, EditableSection, ResumeSections } from './useResumeData';
...
interface ResumeEditorProps {
  ...
  onUpdateInternship: (id: string, key: string, val: string | number | boolean | string[]) => void;
  onDeleteInternship: (id: string) => void;
  onAddProject: () => void;
  onUpdateProject: (id: string, key: string, val: string | number | boolean | string[]) => void;
  onDeleteProject: (id: string) => void;
  onAddSkillCategory: () => void;
  onUpdateSkillCategory: (id: string, key: string, val: string | number | boolean | string[]) => void;
  onDeleteSkillCategory: (id: string) => void;
  onAddCertification: () => void;
  onUpdateCertification: (id: string, key: string, val: string | number | boolean | string[]) => void;
...
function SectionPanel({ label, icon: Icon, isOpen, onToggle, children }: {
