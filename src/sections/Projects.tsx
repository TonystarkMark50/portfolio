    ...
    <Section id="projects" className="bg-gradient-to-b from-gray-50 via-white to-gray-50 dark:from-dark-900 dark:via-dark-800 dark:to-dark-900">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        {projects.map((project, index) => {
          ...
          return (
            <div key={project.id} className="group relative overflow-hidden rounded-3xl bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 transition-all duration-500 shadow-xl hover:shadow-2xl hover:border-violet-300 dark:hover:border-violet-700">
