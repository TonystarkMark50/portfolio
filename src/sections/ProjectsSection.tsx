      ...
      <div className="text-center mb-16">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-violet-500/10 border border-violet-200 dark:border-violet-800/30 mb-6">
          ...
          <span className="text-sm font-medium text-violet-600 dark:text-violet-400">
            {projects.length === 1 ? 'Featured Project' : `${projects.length} Projects`}
          </span>
        </div>
        ...
        <p className="max-w-2xl mx-auto text-xl text-theme-muted leading-relaxed">
          Biomedical engineering projects focused on IoT-based healthcare technology and wearable solutions.
        </p>
      </div>
          ...
          return (
            <div key={project.id} className="group relative overflow-hidden rounded-3xl bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-700 transition-[box-shadow,border-color] duration-250 shadow-xl hover:shadow-2xl hover:border-violet-300 dark:hover:border-violet-700">
              ...
              <div className="relative z-10 p-8 md:p-12">
                ...
                <h3 className="text-3xl font-bold text-theme-primary mb-8 group-hover:text-violet-600 dark:group-hover:text-violet-400 transition-[color] duration-200">
                  {project.name}
                </h3>
                  ...
                  <div className="mt-12 pt-8 border-t border-gray-200 dark:border-slate-800">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                      ...
                      <a
                        ...
                        className="group/btn inline-flex items-center justify-center gap-2 w-full sm:w-auto px-6 py-3 rounded-xl text-sm font-semibold text-white bg-gradient-to-r from-primary-500 to-accent-500 hover:scale-105 active:scale-95 transition-[transform,box-shadow] duration-200 shadow-lg hover:shadow-glow focus:outline-none focus:ring-4 focus:ring-primary-500/30"
                      >
